    ...
    <div class="signUp">
        <div class="signInDetails">
            ...
            <form>
				...
				<div class="password-input" v-for="(isShowedPassword, index) in isShowedPasswords" :key="index">
                    <input
                    ...
                    />
                    <i
                      :class="isShowedPassword ? 'pi pi-eye-slash' : 'pi pi-eye'"
        ...
        <div class="swiperImg">
            <swiper
              ...
              :space-between="50"
            >
              <swiper-slide class="slideImg" v-for="(data) in Datas" :key="data.id">
                <img :src="data.img" alt="sign in image" id="img">
              </swiper-slide>
              ...
            </swiper>
        </div>
...
<script setup>
  ...
  import 'swiper/css';
    import img from "@/assets/image/Podcast.jpeg";
import { ref } from 'vue';
    ...
    const isShowedPasswords = ref([false, false])

    const togglePassword = (index) => {
        isShowedPasswords.value[index] = !isShowedPasswords.value[index]
    } 
